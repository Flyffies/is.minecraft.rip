...
{
    // Useragent
    const USER_AGENT = 'Is Minecraft rip?';
        ...
        foreach ($Checks as $Check) {
            ...
            if ($Check['Name'] === 'login') {
                cURL_SetOpt_Array($Slave, Array(
                    CURLOPT_POST => true,
                    CURLOPT_POSTFIELDS => '{"agent":"Minecraft","clientToken":"","username":"put-valid-username","password":"put-valid-password"}',
